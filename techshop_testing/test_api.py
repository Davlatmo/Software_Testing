...
# Import the Flask app object — we'll run it in a background thread
...
class TestAuthAPI(TestBase):
    ...
    def test_login_with_valid_credentials(self):
        ...
        r = self.session.post(
            ...
            json={"email": "demo@techshop.io", "password": "demo123"},
        )
        ...
        self.assertEqual(data["user"]["email"], "demo@techshop.io")
